...
class BaseExtensionSerializer(serializers.ModelSerializer):
    """A simple serializer for KalabashExtension."""
...
class KalabashExtensionSerializer(BaseExtensionSerializer):
    """A serializer for the KalabashExtension model."""
...
class InstanceSerializer(serializers.ModelSerializer):
    ...
    def set_instance_extensions(self, instance, extensions):
        ...
        extensions = models.KalabashExtension.objects.filter(
    ...
    def create(self, validated_data):
        ...
        instance = models.KalabashInstance.objects.create(
